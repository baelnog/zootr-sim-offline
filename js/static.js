...
var skulltulasByRegionChild = {
  'Kokiri Forest': ["KF GS Know It All House", 'KF GS Bean Patch'],
  'Deku Tree': ["Deku Tree GS Compass Room", "Deku Tree GS Basement Gate", "Deku Tree GS Basement Vines", "Deku Tree GS Basement Back Room"],
  'Lost Woods': ["LW GS Bean Patch Near Bridge", "LW GS Bean Patch Near Theater"],
  'Sacred Forest Meadow': [],
  'Hyrule Field': ["HF GS Near Kak Grotto", "HF GS Cow Grotto"],
  'Market': ["Market GS Guard House"],
  'Temple of Time': [],
  'Hyrule Castle': ["HC GS Tree", "HC GS Storms Grotto"],
  'Lon Lon Ranch': ["LLR GS Tree", "LLR GS Rain Shed", "LLR GS House Window", "LLR GS Back Wall"],
  'Lake Hylia': ["LH GS Bean Patch", "LH GS Lab Wall", "LH GS Small Island"],
  'Gerudo Valley': ["GV GS Small Bridge", "GV GS Bean Patch"],
  'Desert Colossus': ["Colossus GS Bean Patch"],
  'Haunted Wasteland': ["Wasteland GS"],
  'Spirit Temple': ["Spirit Temple GS Metal Fence", "Spirit Temple GS Sun on Floor Room", "Spirit Temple GS Hall After Sun Block Room"],
  'Kakariko Village': ["Kak GS House Under Construction", "Kak GS Skulltula House", "Kak GS Near Gate Guard", "Kak GS Tree", "Kak GS Watchtower"],
  'Bottom of the Well': ["Bottom of the Well GS West Inner Room", "Bottom of the Well GS East Inner Room", "Bottom of the Well GS Like Like Cage"],
  'Above Graveyard': [],
  'Graveyard': ["Graveyard GS Wall", "Graveyard GS Bean Patch"],
  'Death Mountain Trail': ["DMT GS Bean Patch", "DMT GS Near Kak"],
  'Death Mountain Crater': ["DMC GS Crate", "DMC GS Bean Patch"],
  'Goron City': ["GC GS Boulder Maze"],
  'Dodongos Cavern': ["Dodongos Cavern GS Side Room Near Lower Lizalfos", "Dodongos Cavern GS Scarecrow", "Dodongos Cavern GS Back Room", "Dodongos Cavern GS Alcove Above Stairs"],
  'Zora River': ["ZR GS Ladder", "ZR GS Tree"],
  'Zoras Domain': [],
  'Zoras Fountain': ["ZF GS Tree", "ZF GS Above the Log"],
...
var skulltulasByRegionAdult = {
  'Kokiri Forest': ["KF GS House of Twins"],
  'Lost Woods': ["LW GS Bean Patch Near Theater"],
  'Sacred Forest Meadow': ["SFM GS"],
  'Forest Temple': ["Forest Temple GS First Room", "Forest Temple GS Lobby", "Forest Temple GS Raised Island Courtyard", "Forest Temple GS Level Island Courtyard", "Forest Temple GS Basement"],
  'Hyrule Field': ["HF GS Near Kak Grotto", "HF GS Cow Grotto"],
  'Market': [],
  'Temple of Time': [],
  'Lon Lon Ranch': [],
  'Lake Hylia': ["LH GS Tree", "LH GS Lab Crate"],
  'Water Temple': ["Water Temple GS Behind Gate", "Water Temple GS River", "Water Temple GS Falling Platform Room", "Water Temple GS Central Pillar", "Water Temple GS Near Boss Key Chest"],
  'Gerudo Valley': ["GV GS Behind Tent", "GV GS Pillar"],
  'Gerudo Fortress': ["GF GS Archery Range", "GF GS Top Floor"],
  'Gerudo Training Ground': [],
  'Haunted Wasteland': ["Wasteland GS"],
  'Desert Colossus': ["Colossus GS Tree", "Colossus GS Hill"],
  'Spirit Temple': ["Spirit Temple GS Sun on Floor Room", "Spirit Temple GS Hall After Sun Block Room", "Spirit Temple GS Boulder Room", "Spirit Temple GS Lobby"],
  'Kakariko Village': ["Kak GS Above Impas House"],
  'Graveyard': [],
  'Above Graveyard': [],
  'Shadow Temple': ["Shadow Temple GS Invisible Blades Room", "Shadow Temple GS Falling Spikes Room", "Shadow Temple GS Single Giant Pot", "Shadow Temple GS Near Ship", "Shadow Temple GS Triple Giant Pot"],
  'Death Mountain Trail': ["DMT GS Near Kak", "DMT GS Falling Rocks Path", "DMT GS Above Dodongos Cavern"],
  'Death Mountain Crater': [],
  'Fire Temple': ["Fire Temple GS Boss Key Loop", "Fire Temple GS Song of Time Room", "Fire Temple GS Boulder Maze", "Fire Temple GS Scarecrow Climb", "Fire Temple GS Scarecrow Top"],
  'Goron City': ["GC GS Center Platform"],
  'Dodongos Cavern': ["Dodongos Cavern GS Side Room Near Lower Lizalfos", "Dodongos Cavern GS Vines Above Stairs", "Dodongos Cavern GS Back Room", "Dodongos Cavern GS Alcove Above Stairs", "Dodongos Cavern GS Scarecrow"],
  'Zora River': ["ZR GS Near Raised Grottos", "ZR GS Above Bridge"],
  'Zoras Domain': ["ZD GS Frozen Waterfall"],
  'Zoras Fountain': ["ZF GS Hidden Cave"],
  'Ice Cavern': ["Ice Cavern GS Spinning Scythe Room", "Ice Cavern GS Heart Piece Room", "Ice Cavern GS Push Block Room"],
